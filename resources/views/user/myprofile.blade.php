...
<!-- 
    ...
    <div class="d-flex justify-content-end" style="margin-right:80px">              
        <div id="DeleteDiv" style = ""> <button class="btn btn-primary my-2 waves-effect waves-light mx-2" data-bs-toggle="modal" id="btn-pay" > Pay </button></div>
    </div>
